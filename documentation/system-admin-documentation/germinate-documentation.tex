...
\newcommand{\instanceStuff}{\texttt{instance-\allowbreak stuff}}
\newcommand{\germinate}{Germinate}
\newcommand{\gatekeeper}{Germinate Gatekeeper}
\newcommand{\version}{3.4.0}
\newcommand{\versionUnderscore}{3\textunderscore4\textunderscore0}
