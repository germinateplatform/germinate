...
public class PhenotypeDataImporter extends DataImporter<PhenotypeData>
{
	...
	private   Map<String, Accession> accessions = new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
	private   Map<String, Long>      treatments = new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
	private   Map<String, Long>      phenotypes = new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
	...
	private Map<String, Long> phenotypeDatas          = new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
