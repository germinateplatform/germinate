 ...
 */
public class LessThanEquals implements ComparisonOperator, PotentialNumeric
{
	private static final long serialVersionUID = -6373604387831323214L;
	...
	public String toPreparedStatementString(List<String> values) throws InvalidArgumentException
	{
		if (values.size() < 1)
		{
			throw new InvalidArgumentException("Less than comparison requires that one comparison value is provided.");
		}
