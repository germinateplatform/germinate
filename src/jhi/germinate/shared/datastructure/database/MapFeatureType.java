 ...
 */
public class MapFeatureType extends DatabaseObject
{
	private static final long serialVersionUID = -6382743878066316083L;
	...
	public MapFeatureType()
	{
	}

	public MapFeatureType(Long id)
	{
		super(id);
	}
	...
	public MapFeatureType setDescription(String description)
	{
	...
	public MapFeatureType setCreatedOn(Date createdOn)
	{
		if (createdOn == null)
			this.createdOn = null;
		else
	...
	public MapFeatureType setUpdatedOn(Date updatedOn)
	{
		if (updatedOn == null)
			this.updatedOn = null;
		else
	...
	@GwtIncompatible
	public static class Parser extends DatabaseObjectParser<MapFeatureType>
	{
		...
		@Override
		public MapFeatureType parse(DatabaseResult row, UserAuth user, boolean foreignsFromResultSet) throws DatabaseException
		{
	...
	@GwtIncompatible
	public static class Writer implements DatabaseObjectWriter<MapFeatureType>
	{
		public static final class Inst
		{
			private static final class InstanceHolder
		...
		@Override
		public void write(Database database, MapFeatureType object, boolean isUpdate) throws DatabaseException
		{
