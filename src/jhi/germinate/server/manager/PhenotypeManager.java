...
public class PhenotypeManager extends AbstractManager<Phenotype>
{
	...
	public static PaginatedServerResult<List<PhenotypeData>> getAllForFilter(UserAuth user, PartialSearchQuery filter, Pagination pagination) throws DatabaseException, InvalidSearchQueryException, InvalidArgumentException, InvalidColumnException
	{
		pagination.updateSortColumn(PhenotypeService.COLUMNS_SORTABLE, Accession.ID);
		...
		return AbstractManager.<PhenotypeData>getFilteredDatabaseObjectQuery(user, filter, formatted, PhenotypeService.COLUMNS_SORTABLE, pagination.getResultSize())
				.setLongs(datasetIds)
