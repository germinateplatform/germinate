...
public class AccessionManager extends AbstractManager<Accession>
{
	...
	private static final String SELECT_SYNONYMS = "germinatebase.*, entitytypes.*, taxonomies.*, locations.*, countries.*, biologicalstatus.*, institutions.*, collectingsources.*, GROUP_CONCAT(synonyms.synonym SEPARATOR ', ') AS synonyms";
