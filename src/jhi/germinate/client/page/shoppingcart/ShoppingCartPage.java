...
/**
 * {@link ShoppingCartPage} is a page listing the items marked in the {@link ShoppingCart}
 *
 * @author Sebastian Raubach
 */
public class ShoppingCartPage extends GerminateComposite
{
	@Override
	...
	protected void setUpContent()
	{
		...
		ShoppingCart.ItemType selectedType = ItemTypeParameterStore.Inst.get().get(Parameter.shoppingCartItemType);

		for (ShoppingCart.ItemType type : ShoppingCart.ItemType.values())
		{
