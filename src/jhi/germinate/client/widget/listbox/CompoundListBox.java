 ...
 */
public class CompoundListBox extends GerminateValueListBox<Compound>
{
	...
	public CompoundListBox(boolean multiSelect)
	{
		super(new GerminateUnitRenderer<Compound>()
		{
			@Override
			protected String getText(Compound object)
			{
				return object.getName();
			}

			@Override
			protected String getUnit(Compound object)
			{
