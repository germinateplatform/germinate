...
{
	String[] COLUMNS_MAPDEFINITION_TABLE = {Group.ID, Marker.ID, Marker.MARKER_NAME, Map.ID, Map.NAME, Map.DESCRIPTION, MapFeatureType.DESCRIPTION, MapDefinition.CHROMOSOME, MapDefinition.DEFINITION_START, Marker.SYNONYMS, Synonym.SYNONYM};
