 ...
 */
public class IntegerParameterStore extends TypedParameterStore<Integer>
{
	public final static class Inst
	{
		...
		{
			private static final IntegerParameterStore INSTANCE = new IntegerParameterStore();
		}

		public static IntegerParameterStore get()
		{
