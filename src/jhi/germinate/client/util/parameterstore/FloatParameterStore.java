 ...
 */
public class FloatParameterStore extends TypedParameterStore<Float>
{
	public final static class Inst
	{
		...
		{
			private static final FloatParameterStore INSTANCE = new FloatParameterStore();
		}

		public static FloatParameterStore get()
		{
	...
	@Override
	protected Float stringToValue(String value)
	{
		try
		{
