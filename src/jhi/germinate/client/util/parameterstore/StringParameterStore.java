 ...
 */
public class StringParameterStore extends TypedParameterStore<String>
{
	public final static class Inst
	{
		...
		{
			private static final StringParameterStore INSTANCE = new StringParameterStore();
		}

		public static StringParameterStore get()
		{
