 ...
 */
public class FlapjackAllelefreqBinningResultParameterStore extends TypedParameterStore<FlapjackAllelefreqBinningResult>
{
	public final static class Inst
	{
		...
		{
			private static final FlapjackAllelefreqBinningResultParameterStore INSTANCE = new FlapjackAllelefreqBinningResultParameterStore();
		}

		public static FlapjackAllelefreqBinningResultParameterStore get()
		{
	...
	@Override
	protected FlapjackAllelefreqBinningResult stringToValue(String value)
	{
		return null;
	}
